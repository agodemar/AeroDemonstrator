...
class Vec3dVec(object):
    ...
    def as_numpy(self):
        return _vsp_g.Vec3dVec_as_numpy(self)
...
ENGINE_MODE_FLOWTHROUGH_NEG_ONLY = _vsp_g.ENGINE_MODE_FLOWTHROUGH_NEG_ONLY
...
ENGINE_MODE_TO_FACE_NEG_ONLY = _vsp_g.ENGINE_MODE_TO_FACE_NEG_ONLY
...
LINEAR_SWEPT_VOLUME_ANALYSIS = _vsp_g.LINEAR_SWEPT_VOLUME_ANALYSIS
VISIBLE_AT_SURF_ANALYSIS = _vsp_g.VISIBLE_AT_SURF_ANALYSIS
...
COBRA_GEOM_SCREEN = _vsp_g.COBRA_GEOM_SCREEN
...
EXTENT_FORWARD_INF = _vsp_g.EXTENT_FORWARD_INF
EXTENT_REVERSE_INF = _vsp_g.EXTENT_REVERSE_INF
EXTENT_FORWARD_FINITE = _vsp_g.EXTENT_FORWARD_FINITE
EXTENT_REVERSE_FINITE = _vsp_g.EXTENT_REVERSE_FINITE
EXTENT_SLIDER_FULL = _vsp_g.EXTENT_SLIDER_FULL
EXTENT_SLIDER_BEFORE = _vsp_g.EXTENT_SLIDER_BEFORE
EXTENT_SLIDER_AFTER = _vsp_g.EXTENT_SLIDER_AFTER
MOTION_NUM_EXTENT_TYPES = _vsp_g.MOTION_NUM_EXTENT_TYPES
...
SS_INTERSECT = _vsp_g.SS_INTERSECT
...
def LimitedIntersectSurfaces(geomvec, ptchains, uwchains):
    r"""LimitedIntersectSurfaces(StringVector geomvec, vector< vector< vec3d > > & ptchains, vector< vector< vec3d > > & uwchains)"""
    return _vsp_g.LimitedIntersectSurfaces(geomvec, ptchains, uwchains)
...
class vec3d(object):
    ...
    def as_numpy(self):
        return _vsp_g.vec3d_as_numpy(self)
...
def proj_pnt_on_ray(*args):
    ...
    """
    return _vsp_g.proj_pnt_on_ray(*args)
...
def raySphereIntersectionFromInside(p, v, c, r, x):
    ...
    return _vsp_g.raySphereIntersectionFromInside(p, v, c, r, x)
class vec2d(object):
